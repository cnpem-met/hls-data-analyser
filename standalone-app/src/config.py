...
HLS_MAPPING_SECTOR = [17, 16, 15, 14, 13, 1.5, 1.2, 20, 19, 18, 6.8, 6.2, 5, 4, 3, 11.5, 11.2, 10, 9, 8]
HLS_MAPPING_AXIS =   [4, 1, 59, 57, 54, 18, 16, 14, 12, 9, 33, 31, 29, 27, 24, 48, 46, 44, 42, 39]